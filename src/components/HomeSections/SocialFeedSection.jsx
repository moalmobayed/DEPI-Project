...
export function SocialFeed() {
  ...
  return (
    <section className="d-flex flex-column align-items-center px-5 gap-3 w-100">
      <div
        className="d-flex flex-column align-items-center px-5 pt-5 w-100 border-top"
        style={{ paddingTop: "90px", borderTopColor: "#262626", gap: "25px" }}
      >
        ...
        <div className="d-flex flex-column align-items-center gap-1 w-100">
          ...
          >
            Share your latest scent with #PerfumeOnYou for a chance to be
            featured.
          </p>
          <button
            className="w-100 text-center text-dark border-0 bg-transparent text-decoration-underline"
            style={{ letterSpacing: "1.4px" }}
          >
            Add Your Photo
          </button>
      ...
      <div
        className="d-flex justify-content-center align-items-start gap-3 w-100 position-relative"
        style={{ height: "225px" }}
      >
        <div
          className="d-flex justify-content-center align-items-center position-absolute start-0 top-50 translate-middle-y z-3"
        ...
        <div
          className="d-flex gap-3 w-100 overflow-hidden position-relative"
          style={{ height: "225px" }}
        >
          <div
          ...
          >
            {socialImages.map((image, index) => (
              <div
                ...
                style={{ minWidth: "20%", height: "225px" }}
              >
                <img
                  src={image}
        ...
        <div
          className="d-flex justify-content-center align-items-center position-absolute end-0 top-50 translate-middle-y z-3"
          style={{ width: "40px", height: "40px" }}
        >
          <button
            className="d-flex justify-content-center align-items-center border-0 bg-white rounded-circle shadow-sm"
